...
RUN wget -O /THIRD-PARTY-LICENSES-20200824.tar.gz https://corretto.aws/downloads/resources/licenses/alpine/THIRD-PARTY-LICENSES-20200824.tar.gz && \
    ...
    apk add --no-cache amazon-corretto-18=$version-r0
...
VOLUME [ "/tmp" ]
EXPOSE 8080
ADD ./build/libs/chargecard-api-0.0.1-SNAPSHOT.jar chargecard-api-aws.jar
ENTRYPOINT ["java", "-jar", "/chargecard-api-aws.jar"]
